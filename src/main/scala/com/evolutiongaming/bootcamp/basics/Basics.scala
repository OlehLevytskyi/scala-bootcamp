...
object Basics {
  ...
  val helloFunction: String => String = (name: String) => {
    helloMethod(name)/* implement here */
  }
  ...
  val allEitherUnitBooleans: Set[Either[Unit, Boolean]] = Set(Left(true), Right(false), null)
